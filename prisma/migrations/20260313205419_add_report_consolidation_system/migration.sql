...
-- CreateTable
CREATE TABLE "ConsolidatedStudentSummary" (
    "id" TEXT NOT NULL,
    "resultTermId" TEXT NOT NULL,
    "studentId" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "ResultTerm_academicSessionId_idx" ON "ResultTerm"("academicSessionId");

-- CreateIndex
CREATE INDEX "ResultTerm_classId_idx" ON "ResultTerm"("classId");

-- CreateIndex
CREATE INDEX "ResultTerm_isPublished_idx" ON "ResultTerm"("isPublished");

-- CreateIndex
CREATE INDEX "ResultTerm_isActive_idx" ON "ResultTerm"("isActive");

-- CreateIndex
CREATE UNIQUE INDEX "ResultTerm_name_academicSessionId_classId_key" ON "ResultTerm"("name", "academicSessionId", "classId");

-- CreateIndex
CREATE INDEX "ResultExamGroup_resultTermId_idx" ON "ResultExamGroup"("resultTermId");

-- CreateIndex
CREATE UNIQUE INDEX "ResultExamGroup_resultTermId_sortOrder_key" ON "ResultExamGroup"("resultTermId", "sortOrder");

-- CreateIndex
CREATE UNIQUE INDEX "ResultExamGroup_resultTermId_name_key" ON "ResultExamGroup"("resultTermId", "name");

-- CreateIndex
CREATE INDEX "ResultExamLink_examGroupId_idx" ON "ResultExamLink"("examGroupId");

-- CreateIndex
CREATE INDEX "ResultExamLink_examId_idx" ON "ResultExamLink"("examId");

-- CreateIndex
CREATE UNIQUE INDEX "ResultExamLink_examGroupId_examId_key" ON "ResultExamLink"("examGroupId", "examId");

-- CreateIndex
CREATE INDEX "ConsolidatedResult_resultTermId_studentId_idx" ON "ConsolidatedResult"("resultTermId", "studentId");

-- CreateIndex
CREATE INDEX "ConsolidatedResult_resultTermId_subjectId_idx" ON "ConsolidatedResult"("resultTermId", "subjectId");

-- CreateIndex
CREATE INDEX "ConsolidatedResult_resultTermId_rankInClass_idx" ON "ConsolidatedResult"("resultTermId", "rankInClass");

-- CreateIndex
CREATE INDEX "ConsolidatedResult_resultTermId_rankInSection_idx" ON "ConsolidatedResult"("resultTermId", "rankInSection");

-- CreateIndex
CREATE INDEX "ConsolidatedResult_isStale_idx" ON "ConsolidatedResult"("isStale");

-- CreateIndex
CREATE UNIQUE INDEX "ConsolidatedResult_resultTermId_studentId_subjectId_key" ON "ConsolidatedResult"("resultTermId", "studentId", "subjectId");

-- CreateIndex
CREATE INDEX "ConsolidatedStudentSummary_resultTermId_rankInClass_idx" ON "ConsolidatedStudentSummary"("resultTermId", "rankInClass");

-- CreateIndex
CREATE INDEX "ConsolidatedStudentSummary_resultTermId_rankInSection_idx" ON "ConsolidatedStudentSummary"("resultTermId", "rankInSection");

-- CreateIndex
CREATE INDEX "ConsolidatedStudentSummary_resultTermId_overallPercentage_idx" ON "ConsolidatedStudentSummary"("resultTermId", "overallPercentage");

-- CreateIndex
CREATE INDEX "ConsolidatedStudentSummary_resultTermId_sectionId_idx" ON "ConsolidatedStudentSummary"("resultTermId", "sectionId");

-- CreateIndex
CREATE INDEX "ConsolidatedStudentSummary_isStale_idx" ON "ConsolidatedStudentSummary"("isStale");

-- CreateIndex
CREATE UNIQUE INDEX "ConsolidatedStudentSummary_resultTermId_studentId_key" ON "ConsolidatedStudentSummary"("resultTermId", "studentId");
